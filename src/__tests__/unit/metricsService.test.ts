...
describe('MetricsService', () => {
  ...
  describe('incrementCounter', () => {
    ...
    it('should increment counter with labels', () => {
      metricsService.incrementCounter('test_counter', { method: 'GET' });
      metricsService.incrementCounter('test_counter', { method: 'POST' });
  ...
  describe('recordHistogram', () => {
    it('should record histogram values', () => {
      metricsService.recordHistogram('test_histogram', 10);
      metricsService.recordHistogram('test_histogram', 20);
      metricsService.recordHistogram('test_histogram', 30);
    ...
    it('should calculate percentiles correctly', () => {
      ...
      values.forEach(v => metricsService.recordHistogram('test_histogram', v));
